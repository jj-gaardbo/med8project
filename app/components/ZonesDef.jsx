            ...
            <div {...this.props}>
                <svg version="1.1" id="Layer_6" x="0px" y="0px"
                     width="916px" height="1360px" viewBox="0 0 916 1360" enableBackground="new 0 0 916 1360">
                        <rect className={phase === 10 ? "highlight-zone highlight-def" : ""} x="-1" y="2" opacity="0.3" width="916" height="471"/>
                        <rect className={phase === 12 ? "highlight-zone highlight-def" : ""} x="-1" y="895" opacity="0.3" width="916" height="465"/>
                        <rect className={phase === 11 ? "highlight-zone highlight-def" : ""} x="-1" y="473" opacity="0.3" width="916" height="422"/>
